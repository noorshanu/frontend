...
const Footer = () => {
  ...
  const issueUrl = 'https://github.com/Deelance-Organization/freelance-platform-deelance';
  ...
  const renderProjectInfo = React.useCallback((gridArea?: GridProps['gridArea']) => {
    return (
      <Box gridArea={ gridArea }>
        ...
        It is at the forefront of the revolution. With our decentralized approach, we are connecting freelancers, leveraging the power of blockchain technology.
        </Text>
